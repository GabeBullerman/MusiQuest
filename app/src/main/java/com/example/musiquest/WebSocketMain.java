...
public class WebSocketMain extends AppCompatActivity implements WebSocketListener{

    private String BASE_URL = "ws://10.90.73.143:8080/chat/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_websocket);
